                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <div class="content content-full text-center">
                            ...
                            @php
                                $url = app()->environment('local') ? 'http://essentiel.ck/' : secure('http://essentiel.ck/');
                                $picurl = DB::table('teacher')->where('userid', auth()->user()->id )->value('picurl');
                                $domain = $url . $picurl;
                            ...
                            <span class="text-primary font-w600">{{ DB::table('usertype')->where('id',auth()->user()->type )->value('utype')  }}</span>
                        </div>
                    ...
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn btn-sm btn-dual d-flex align-items-center"
                            ...
                            <img class="rounded-circle" 
                                src="{{ $isvalid }}"
                                alt="Header Avatar" style="width: 21px; height: 21px;; object-fit: cover;" >
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0"
                            ...
                            <div class="p-3 text-center bg-primary-dark rounded-top">
                                ...
                                <p class="mb-0 text-white-50 font-size-sm">{{ DB::table('usertype')->where('id',auth()->user()->type )->value('utype')  }}</p>
                            </div>
                            <div class="p-2">
                                {{-- Profile --}}
                                <a class="dropdown-item d-flex align-items-center justify-content-between" href="/view/profile">
