    ...
    <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="mb-1">Search Name <span class="text-danger">*</span> <i class="fa fa-search ml-1"></i></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="js-flatpickr font-size-sm form-control form-control-alt" id="circulation_date_borrowed" name="circulation_date_borrowed" placeholder="Y-m-d" data-date-format="Y-m-d">
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="js-flatpickr font-size-sm form-control form-control-alt" id="circulation_due_date" name="circulation_due_date" placeholder="Y-m-d" data-date-format="Y-m-d">
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        <label class="mb-1">Penalty After Due Date <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control font-size-sm form-control-alt" id="circulation_penalty"
                                            placeholder="0.00">
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" id="date_returned_wrapper" hidden>
                                        ...
                                        <input type="text" class="form-control font-size-sm form-control-alt" id="date_returned"
                                           readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-1">Email Ad</label>
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="borrower_email"
                                         readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-1">Contact No.</label>
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="borrower_phone"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox custom-checkbox-square custom-control-info mb-1">
                                    ...
                                    <div class="form-group mt-2 requested_book_wrapper" hidden>
                                        <label class="mb-1 text-warning">Requested Book <i class="si si-pin ml-2 text-dark"></i> </label>
                                        <select class="form-control font-size-sm form-control-sm" id="select_requested_book"
                                            style="width: 100%;">
                                        </select>
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="title"
                                            readonly>
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="author"
                                            readonly>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-alt font-size-sm " id="callnumber"
                                            readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="mb-1">Publication</label>
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="publisher"
                                             readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="isbn"
                                             readonly>
                                    </div>

                                    <div class="form-group">
                                        <label class="mb-1">Copyright Year</label>
                                        <input type="text" class="form-control form-control-alt font-size-sm" id="copyright"
                                             readonly>
                                    </div>
                                    <div class="form-group">
        ...
        <div class="block block-rounded">
            <div class="block-header bg-primary">
                <h3 class="block-title font-w700" style="font-size: 16px;"> <i class="fa fa-layer-group mr-1"></i>CIRCULATIONS</h3>
                <div class="d-flex align-items-center my-1">
                    ...
                    <div class="dropdown">
                        <button type="button" class="btn btn-alt-primary dropdown-toggle" id="dropdown-align-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            
                        </button>
                        <div class="dropdown-menu dropdown-menu-right font-size-sm" aria-labelledby="dropdown-align-primary">
                            @foreach (DB::table('library_status')->where('status_deleted', 0)->get() as $item)
                                {{-- <option value="{{ $item->id }}">{{ $item->status_name }}</option> --}}
                                <a class="dropdown-item" href="#" onclick="onChangeStatus('{{$item->id}}', '{{$item->status_name}}' )">{{ $item->status_name }}</a>
                            @endforeach
                        </div>
                    </div>
                    <div>
            ...
            <div class="block-content block-content-full">
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-borderless table-vcenter js-dataTable-full" id="DataTables_Table_1"
                        style="width: 100%;">
            ...
            $(document).on('click', '.save_circulation', function() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        circulation_members_id: purpose == 'new' ? circulation_members_id.val() : current_member_id,
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.request && purpose == 'new') {
                        ...
                        $('#select_requested_book').append('<option value="" selected>Choose Requested Book</option>');
        ...
        function load_books(str) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#select-books, #select_requested_book, #select-borrowers, #select-status-form').on('select2:open', function() {
                        // Remove the 'is-invalid' class when the Select2 dropdown is opened
                        $(this).removeClass('is-invalid');
                    });
                }
