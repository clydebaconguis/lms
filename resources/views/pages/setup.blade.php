...
@section('css_before')
    ...
    <style>
        ...
        .select2-container--default .select2-selection--single {
            background-color: #F0F1F2; /* Light gray background color */
...
@section('content')
    ...
    <!-- MODAL USERS -->
    <div class="modal fade" id="modal-block-popin-user" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin-user"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                <div class="block block-rounded block-themed block-transparent mb-0">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-light-gray font-size-sm" id="select-usertype" style="width: 100%;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control form-control-alt font-size-sm" id="password"
                                       >
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control form-control-alt font-size-sm" id="confirm_password"
                                       >
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-alt font-size-sm" id="lib_orgname">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="lib_name">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control font-size-sm form-control-alt" placeholder="e.g, sample@gmail.com" id="lib_email">
                                </div>
                                <div class="form-group">
                                    <label class="mb-1">Contact Number</label>
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="lib_phone">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="mb-1">Website</label>
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="lib_website"
                                       placeholder="www.sample.com" >
                                </div>
                                <div class="form-group">
                                    <label class="mb-1">Department</label>
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="lib_department"
                                        >
                                </div>

                                <div class="form-group">
                                    <div class="custom-control custom-checkbox custom-checkbox-square custom-control-danger">
                                        <input type="checkbox" class="custom-control-input" id="checkbox_multiple_staff"
                                            name="checkbox_returned">
                                        <label class="custom-control-label" for="checkbox_multiple_staff">Multiple Staff </label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="mb-1">In-Charge</label>
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="lib_incharge"
                                         disabled>
                                </div>
                                <div class="form-group">
                                    <label class="mb-1">Assistant</label>
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="lib_asst"
                                         disabled>
                                </div>
                    ...
                    <div class="block-content font-size-sm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control font-size-sm form-control-alt"
                                onkeyup="this.value = this.value.toUpperCase();" id="cat_name"
                                placeholder="">
                                <span class="invalid-feedback" role="alert">
                                    <strong>Name is required</strong>
                                </span>
                    ...
                    <div class="block-content font-size-sm">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_cardno"
                                        placeholder="">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_name"
                                        placeholder="">
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Name is required</strong>
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_class"
                                        placeholder="">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox custom-checkbox-square custom-control-lg custom-control-success">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_email"
                                        placeholder="">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_phone"
                                        placeholder="">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_address"
                                        placeholder="">
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row mt-1">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="mb-1">Username <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control font-size-sm form-control-alt" id="borrower_username"
                            ...
                            <div class="col-md-6 borrow_pass">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control font-size-sm form-control-alt" id="borrower_password"
                                        placeholder="Default (Card Id No.)">
                                    <span class="invalid-feedback" role="alert">
                                        <strong>Password is required</strong>
                                    </span>
                                </div>
    ...
    <div class="content">
        ...
        <div class="block block-rounded" id="tb_lib" hidden>
            ...
            <div class="block-header bg-primary">
                <h3 class="block-title font-w700" style="font-size: 16px;"> <i class="fa fa-wrench mr-1"></i> GENERAL SETUP</h3>
                <button type="button" class="btn ml-auto bg-dark newlib font-size-sm text-light my-1" data-toggle="modal"
            ...
            <div class="block-content block-content-full">
                <div class="table-responsive">
                    <table class="table table-hover table-borderless table-striped table-vcenter js-dataTable-full" id="table_library"
                        style="width: 100%;">
        ...
        <div class="block block-rounded" id="tb_cat" hidden>
            <div class="block-header bg-primary">
                <h3 class="block-title font-w700" style="font-size: 16px;"> <i class="fa fa-wrench mr-1"></i> GENERAL SETUP</h3>
                <button type="button" class="btn ml-auto bg-dark newcat font-size-sm text-light my-1" data-toggle="modal"
                    data-target="#modal-block-popin-cat">
            ...
            <div class="block-content block-content-full">
                <div class="table-responsive">
                           <table class="table table-hover table-striped table-borderless table-vcenter js-dataTable-full" id="table_category"
                        style="width: 100%;">
                        <thead class="thead-dark">
                             <tr>
                                <th width="10%">ID</th>
        ...
        <div class="block block-rounded" id="tb_genre" hidden>
            <div class="block-header bg-primary">
                <h3 class="block-title font-w700" style="font-size: 16px;"> <i class="fa fa-wrench mr-1"></i> GENERAL SETUP</h3>
                <button type="button" class="btn ml-auto bg-dark newgen font-size-sm text-light my-1" data-toggle="modal"
                    data-target="#modal-block-popin-genre">
            ...
            <div class="block-content block-content-full">
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-borderless table-vcenter js-dataTable-full" id="table_genre"
                        style="width: 100%;">
                        <thead class="thead-dark">
                            <tr>
                                <th width="5%">ID</th>
        ...
        <div class="block block-rounded" id="tb_borrower" hidden>
            ...
            <div class="block-content block-content-full">
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-borderless table-vcenter js-dataTable-full" id="table_borrower"
                        style="width: 100%;">
                        <thead class="thead-dark">
                            <tr>
                                <th>Card #</th>
...
@section('js_after')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if ('{{ request()->is('admin/setup/libraries') }}') {
                $('#tb_lib').prop('hidden', false)
                // $('.content-heading').text('LIBRARY INFORMATION')
                load_library_datatable(jsonData)
                $('a[href="/admin/setup/libraries?action=lib"]').addClass('active');
            } else if ('{{ request()->is('admin/setup/category') }}') {
                // $('.content-heading').text('CATEGORIES')
                $('#tb_cat').prop('hidden', false)
                load_category_datatable(jsonData)
                $('a[href="/admin/setup/category?action=cat"]').addClass('active');
            } else if ('{{ request()->is('admin/setup/usertype') }}') {
                $('#tb_usertype').prop('hidden', false)
                load_usertype_datatable(jsonData)
                $('a[href="/admin/setup/usertype?action=usertype"]').addClass('active');
            } else if ('{{ request()->is('admin/setup/genre') }}') {
                // $('.content-heading').text('GENRES')
                $('#tb_genre').prop('hidden', false)
                load_genre_datatable(jsonData)
                $('a[href="/admin/setup/genre?action=genre"]').addClass('active');
            } else if ('{{ request()->is('admin/setup/borrower') }}') {
                // $('.content-heading').text('BORROWERS')
                $('#tb_borrower').prop('hidden', false)
                load_borrower_datatable(jsonData)
                $('a[href="/admin/setup/borrower?action=borrower"]').addClass('active');
            } else {
                // $('.content-heading').text('USERS INFORMATION')
                $('#tb_users').prop('hidden', false)
                console.log(jsonData);
                load_users_datatable(jsonData)
                $('a[href="/admin/setup/users?action=users"]').addClass('active');
            }
