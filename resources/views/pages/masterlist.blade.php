...
@section('css_before')
    ...
    <style>
        ...
        #select-branch + .select2-container .select2-selection--multiple .select2-selection__choice {
            background-color: #C8C9CA; /* Background color for selected items */
            border: 1px solid #C8C9CA; /* Border color for selected items */
        ...
        #select-branch + .select2-container .select2-selection--multiple .select2-selection__choice__remove {
            color: #000; /* Color for the 'x' remove icon on selected items */
        }
    ...
    <div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-alt select2 font-size-sm" id="select-category"
                                            style="width: 100%;">
                                        </select>
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-alt font-size-sm" id="edition"
                                                    onkeyup="this.value = this.value.toUpperCase();">
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-alt font-size-sm" id="select-genre" style="width: 100%;">
                                        </select>
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="js-flatpickr font-size-sm form-control form-control-alt" id="datereceived"
                                            name="datereceived" placeholder="Y-m-d" data-date-format="Y-m-d" >
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-alt font-size-sm" id="quantity"
                                                    placeholder="0">
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control form-control-alt font-size-sm" id="available"
                                                    placeholder="0">
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-alt font-size-sm" id="price"
                                                    placeholder="₱ 0.00">
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-alt font-size-sm" id="select-branch" style="width: 100%;"
                                            multiple>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="mt-2">
                                            <img height="110px" width="100px" alt="book image" id="book_cover" hidden style="object-fit: cover;">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-alt font-size-sm" id="description" rows="8" placeholder="Short description.."></textarea>
                                        <span class="invalid-feedback" role="alert">
        ...
        <div class="block block-rounded">
            <div class="block-header bg-primary">
                <h3 class="block-title font-w700" style="font-size: 16px;"> <i class="fa fa-book mr-1"></i> BOOKS INFORMATION</h3>
                <div class="d-flex align-items-center my-1">
                    <select class="form-control font-size-sm" id="select-library">
                        ...
                        @foreach (DB::table('libraries')->where('deleted', 0)->get() as $item)
                            <option value="{{ $item->id }}">{{ $item->library_name }}</option>
                        @endforeach
                    </select>
                    <div>
            ...
            <div class="block-content block-content-full">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-vcenter table-borderless js-dataTable-full" id="DataTables_Table_1"
                        style="width: 100%;">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            var author = `<div class="mt-1"><a class="font-size-sm">Author: ${capitalizeFirstLetter(row.book_author)}</a></div>`;
                            var publisher = `<div><a class="font-size-sm">Publisher: ${capitalizeFirstLetter(row.book_publisher)}</a></div>`;
                            var title = `
