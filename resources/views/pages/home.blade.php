            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div
                        ...
                        <dl class="mb-0">
                            <dt class="font-size-h2 font-w700">{{ $totalBorrowed }}</dt>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                        <a class="font-w500 d-flex align-items-center" href="/admin/circulation/borrowed?action=2">
                            More Info
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div
                        class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="font-size-h2 font-w700">{{ $totalReturned }}</dt>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                        <a class="font-w500 d-flex align-items-center" href="/admin/circulation/returned?action=3">
                            More Info
                            <i class="fa fa-arrow-alt-circle-right ml-1 opacity-25 font-size-base"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div
                        class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="font-size-h2 font-w700">{{ $totalIssued }}</dt>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                        <a class="font-w500 d-flex align-items-center" href="/admin/circulation/issued?action=1">
                            More Info
                            <i class="fa fa-arrow-alt-circle-right ml-1 opacity-25 font-size-base"></i>
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-xl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div
                        class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="font-size-h2 font-w700">{{ $totalLost }}</dt>
                    ...
                    <div class="block-content block-content-full block-content-sm bg-body-light font-size-sm">
                        <a class="font-w500 d-flex align-items-center" href="/admin/circulation/lost?action=4">
                            More Info
                            <i class="fa fa-arrow-alt-circle-right ml-1 opacity-25 font-size-base"></i>
                        </a>
                    </div>
                        ...
                        <div class="block-options">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right font-size-sm" aria-labelledby="dropdown-align-primary">
                                    ...
                                    <a class="dropdown-item" href="#" onclick="changeMonth('September')">September</a>
                                    <a class="dropdown-item" href="#" onclick="changeMonth('October')">October</a>
                                    <a class="dropdown-item" href="#" onclick="changeMonth('November')">November</a>
                                    <a class="dropdown-item" href="#" onclick="changeMonth('December')">December</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content block-content-full">
                        <div class="table-responsive">
                            <table class="table table-hover table-striped table-vcenter" style="width: 100%;" id="tb_overdue">
                                <thead>
                                    <tr>
                                        <th>Book Name</th>
                    ...
                    return r = e, n = [{
                        ...
                        value: function() {
                            Chart.defaults.global.defaultFontColor = "#495057", Chart.defaults.scale
                                ...
                                .beginAtZero = !0, Chart.defaults.global.elements.line.borderWidth = 0,
                                Chart.defaults.global.elements.point.radius = 0, Chart.defaults.global
                                .elements.point.hoverRadius = 0, Chart.defaults.global.tooltips
                                .cornerRadius = 3, Chart.defaults.global.legend.labels.boxWidth = 12;
                            ...
                            e = {
                                ...
                                options: {
                                    tooltips: {
                                        ...
                                        callbacks: {
                                            label: function(e, r) {
                                                return r.datasets[e.datasetIndex].label +
                                                    ": " + e.yLabel
                                            }
                                        }
                                    }
