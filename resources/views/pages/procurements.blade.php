                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 wrapper_donor" hidden>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-alt font-size-sm" id="donor"
                                                    onkeyup="this.value = this.value.toUpperCase();">
                                                <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-alt font-size-sm" id="description" rows="5" placeholder="Short description.."></textarea>
                                        <span class="invalid-feedback" role="alert">
            ...
            <div class="col-md-6 ">
                <div class="block block-rounded">
                    <div class="block-header bg-secondary">
                        <div class="block-title text-light"><i class="fa fa-archway mr-1"></i> Select Lbrary Branch</div>
                    </div>
                    <div class="block-content block-content-full">
                        <select id="select-library" class="form-control form-control-alt select2 font-size-sm" style="width: 100%;">
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="block block-rounded">
                    ...
                    <div class="block-content block-content-full">
                        <div class="table-responsive">
                            <table class="table table-hover table-vcenter table-striped table-borderless js-dataTable-full" id="tbl_purchase"
                                style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>Categories</th>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $(document).on('change', '#select-library', function(){
                        ...
                        var newUrl = `/admin/procurements/${action}?action=${action}&library_branch=${branch}`;
                        console.log(newUrl);
                        if(branch){
