        ...
        <div class="block block-rounded">
            <div class="block-header bg-primary">
                ...
                <div class="block-options d-flex align-items-center my-1">
                    <div class="mr-2">
                        <i class="si si-size-fullscreen font-w600" id="fullscreenButton" data-toggle="tooltip" title="Fullscreen"></i>
                    </div>
                    <div class="mr-2">
            ...
            <div class="block-content block-content-full">
                <div class="table-responsive">
                    <table class="table table-hover table-striped table-borderless js-dataTable-full" id="tb_catalogue" style="width: 100%;">
                        <thead>
                            <tr>
                                <th width="5%"></th>
                                <th width="20%"></th>
