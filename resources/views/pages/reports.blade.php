        ...
        <div class="block block-rounded" hidden id="tb_circulation">
            <div class="block-header d-flex">
                ...
                <ul class="nav nav-pills ml-auto px-2 font-size-sm">
                    <li class="nav-item "><a class="nav-link" href="/admin/report/circulation?action=circulation">Circulation</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/borrower?action=borrower">Borrower</a></li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/hardreference?action=hardref">HardRef</a></li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/e-reference?action=eref">E-Ref</a></li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/overdue?action=overdue">Overdue</a></li>
                </ul>
            </div>
            ...
            <div class="block-header d-flex">
                ...
                <ul class="nav nav-pills ml-auto px-2 font-size-sm">
                    <li class="nav-item"><a class="nav-link"
                            href="/admin/report/circulation?action=circulation">Circulation</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/borrower?action=borrower">Borrower</a></li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/hardreference?action=hardref">HardRef</a></li>
                    <li class="nav-item"><a class="nav-link" href="/admin/report/e-reference?action=eref">E-Ref</a></li>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (action == 'circulation') {
                ...
                $('a[href="/admin/report/circulation?action=circulation"]').addClass('active');
            } else if (action == 'borrower') {
                $('#tb_borrower').prop('hidden', false)
                load_borrower_datatable(jsonData)
                $('a[href="/admin/report/borrower?action=borrower"]').addClass('active');
            } else if (action == 'hardref') {
                $('#tb_hardref').prop('hidden', false)
                load_hardref_datatable(jsonData)
                $('a[href="/admin/report/hardreference?action=hardref"]').addClass('active');
            } else if (action == 'eref') {
                $('#tb_eref').prop('hidden', false)
                load_eref_datatable(jsonData)
                $('a[href="/admin/report/e-reference?action=eref"]').addClass('active');
            } else if (action == 'overdue') {
                $('#tb_overdue').prop('hidden', false)
                load_overdue_datatable(jsonData)
                $('a[href="/admin/report/overdue?action=overdue"]').addClass('active');
            } else {
